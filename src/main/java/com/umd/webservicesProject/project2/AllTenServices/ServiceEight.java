...
@RestController
public class ServiceEight {
	
	@RequestMapping(value="/8",method=RequestMethod.POST,produces= {"application/json","application/xml"})
	@ResponseBody
	public FinalResponeObject acceptXmlData(@RequestBody CHandlerWebServiceClassTO puser ) {
		...
		finalResponeObject.setServiceName("8");
		//set invocation date
